...
static = [
    ...
    ('/starlink-rethymno.html', '0.8'),
    ('/starlink-rethymno-el.html', '0.8'),
    ('/wifi-airbnb-chania.html', '0.8'),
    ('/wifi-airbnb-chania-el.html', '0.8'),
    ('/cctv-villas-crete.html', '0.8'),
    ('/cctv-villas-crete-el.html', '0.8'),
